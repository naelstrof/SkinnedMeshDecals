...
Shader "Naelstrof/DecalProjectorAlphaBlend"
{
	...
	LOD 100
		...
		Pass
		{
			...
			{
				v2f o;
				float2 texCoord10_g3 = v.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break14_g3 = texCoord10_g3;
				float2 appendResult21_g3 = (float2(break14_g3.x , ( 1.0 - break14_g3.y )));
				#ifdef UNITY_UV_STARTS_AT_TOP
				float2 staticSwitch23_g3 = texCoord10_g3;
				#else
				float2 staticSwitch23_g3 = appendResult21_g3;
				#endif
				float3 objectToClip33_g3 = UnityObjectToClipPos(v.vertex.xyz).xyz;
				float3 appendResult26_g3 = (float3(staticSwitch23_g3 , objectToClip33_g3.z));
				
				float2 vertexToFrag5_g3 = ( (objectToClip33_g3).xy + float2( 0.5,0.5 ) );
				o.ase_texcoord1.xy = vertexToFrag5_g3;
				float3 ase_worldNormal = UnityObjectToWorldNormal(v.ase_normal);
				float3 normalizedWorldNormal = normalize( ase_worldNormal );
				float3 ase_worldPos = mul(unity_ObjectToWorld, float4( (v.vertex).xyz, 1 )).xyz;
				float3 ase_worldViewDir = UnityWorldSpaceViewDir(ase_worldPos);
				ase_worldViewDir = normalize(ase_worldViewDir);
				float dotResult9_g3 = dot( normalizedWorldNormal , ase_worldViewDir );
				float vertexToFrag18_g3 = saturate( sign( dotResult9_g3 ) );
				o.ase_texcoord1.z = vertexToFrag18_g3;
				...
				#endif
				vertexValue = ( ( appendResult26_g3 * float3( 2,-2,1 ) ) + float3( -1,1,0 ) );
...
#endif
				float2 vertexToFrag5_g3 = i.ase_texcoord1.xy;
				float2 break6_g3 = vertexToFrag5_g3;
				float2 appendResult13_g3 = (float2(break6_g3.x , ( 1.0 - break6_g3.y )));
				#ifdef UNITY_UV_STARTS_AT_TOP
				float2 staticSwitch16_g3 = vertexToFrag5_g3;
				#else
				float2 staticSwitch16_g3 = appendResult13_g3;
				#endif
				float4 tex2DNode19_g3 = tex2Dlod( _MainTex, float4( staticSwitch16_g3, 0, 0.0) );
				float vertexToFrag18_g3 = i.ase_texcoord1.z;
				float4 appendResult22_g3 = (float4(1.0 , 1.0 , 1.0 , vertexToFrag18_g3));
				#ifdef _BACKFACECULLING_ON
				float4 staticSwitch28_g3 = ( tex2DNode19_g3 * appendResult22_g3 );
				#else
				float4 staticSwitch28_g3 = tex2DNode19_g3;
				#endif
				
				
				finalColor = ( _Color * saturate( staticSwitch28_g3 ) );
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;111;640,-128;Inherit;False;ProjectDecal;0;;3;66b18916e8faf2e499cabbb30e9dd724;0;1;34;SAMPLER2D;0;False;2;COLOR;0;FLOAT3;32
...
WireConnection;111;34;108;0
WireConnection;110;0;109;0
WireConnection;110;1;111;0
WireConnection;42;0;110;0
WireConnection;42;1;111;32
ASEEND*/
//CHKSM=3913AD6755694BEDF40A5B92DF108C1AF518CCF2