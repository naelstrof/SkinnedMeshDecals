...
Shader "Naelstrof/DecalProjectorHDRP"
{
	Properties
	{
		...
		_UVProjection("UVProjection", Range(0, 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput Vert( VertexInput inputMesh  )
			{
				...
				float2 uv17 = inputMesh.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 appendResult8 = (float4(uv17 , 0.0 , 1.0));
				
				float4 unityObjectToClipPos38 = TransformWorldToHClip(TransformObjectToWorld(float4(inputMesh.positionOS,1).xyz));
				...
				#endif
				float3 vertexValue = ( ( appendResult8 * float4( 2,-2,0,0 ) ) + float4( -1,1,0,0 ) ).xyz;
				//#ifdef ASE_ABSOLUTE_VERTEX_POS
				...
				o.positionCS = lerp(float4(vertexValue, 1), TransformWorldToHClip(positionRWS), _UVProjection);
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 vertexToFrag32 = packedInput.ase_texcoord1;
				float4 temp_output_40_0 = ( _BaseColor * tex2D( _Decal, vertexToFrag32.xy ) );
				
				surfaceDescription.Color = temp_output_40_0.rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = temp_output_40_0.a;
		...
		Pass
		{
			...
			VertexOutput Vert( VertexInput inputMesh  )
			{
				...
				float2 uv17 = inputMesh.uv1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 appendResult8 = (float4(uv17 , 0.0 , 1.0));
				
				float4 unityObjectToClipPos38 = TransformWorldToHClip(TransformObjectToWorld(float4(inputMesh.positionOS,1).xyz));
				float4 vertexToFrag32 = ( unityObjectToClipPos38 + float4( 0.5,0.5,0,0 ) );
				o.ase_texcoord = vertexToFrag32;
				...
				o.positionCS = float4( uv * 2.0 - 1.0, vertexValue.z > 0 ? 1.0e-4 : 0.0, 1.0 );
				return o;
			}
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 vertexToFrag32 = packedInput.ase_texcoord;
				float4 temp_output_40_0 = ( _BaseColor * tex2D( _Decal, vertexToFrag32.xy ) );
...
Version=18000
2144;169;1418;736;1357.378;718.3182;1.837913;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;15.79401,-377.8186;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;54;111.1147,-139.3755;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;47;644.8629,-53.67207;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;e4e800d03f8e1ce43bcf828b5fe05722;True;DepthForwardOnly;0;4;DepthForwardOnly;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-26;False;True;True;0;True;-7;255;False;-1;255;True;-8;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;49;644.8629,-53.67207;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;e4e800d03f8e1ce43bcf828b5fe05722;True;DistortionVectors;0;6;DistortionVectors;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;True;0;True;-26;False;True;True;0;True;-11;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;43;644.8629,-53.67207;Float;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;17;Naelstrof/DecalProjectorHDRP;e4e800d03f8e1ce43bcf828b5fe05722;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-20;0;True;-21;1;0;True;-22;0;True;-23;False;False;True;2;False;-19;False;True;True;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-18;True;7;False;-32;False;True;1;LightMode=ForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;19;Surface Type;0;  Rendering Pass ;0;  Rendering Pass;1;  Blending Mode;0;  Receive Fog;1;  Distortion;0;    Distortion Mode;0;    Distortion Only;1;  Depth Write;1;  Cull Mode;0;  Depth Test;4;Double-Sided;1;Alpha Clipping;0;Motion Vectors;0;  Add Precomputed Velocity;0;Shadow Matte;0;Cast Shadows;0;GPU Instancing;1;Vertex Position,InvertActionOnDeselection;0;0;7;True;False;True;True;True;False;False;False;;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;44;644.8629,-53.67207;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;e4e800d03f8e1ce43bcf828b5fe05722;True;ShadowCaster;0;1;ShadowCaster;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;45;644.8629,-53.67207;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;e4e800d03f8e1ce43bcf828b5fe05722;True;META;0;2;META;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;2;False;-1;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;46;644.8629,-53.67207;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;e4e800d03f8e1ce43bcf828b5fe05722;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=SceneSelectionPass;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;48;644.8629,-53.67207;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;e4e800d03f8e1ce43bcf828b5fe05722;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-26;False;True;True;0;True;-9;255;False;-1;255;True;-10;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
...
WireConnection;43;2;54;3
WireConnection;43;6;10;0
ASEEND*/
//CHKSM=3CD0CDFEDF7E4F1B77AF10A10A95CFF6F62B24A5